...
# Generated by qmake (2.01a) (Qt 4.6.2) on: lun mar 19 10:59:32 2012
...
SOURCES       = main.cpp \
		...
		lib3ds/atmosphere.c \
		cameracontrol.cpp \
		collisionmanager.cpp moc_uigc2.cpp \
		moc_GLWidget.cpp
OBJECTS       = main.o \
		uigc2.o \
		Model.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/EntornQTGC21.0.0/ && $(COPY_FILE) --parents uigc2.h Util.h Model.h GLWidget.h objectloader.h lib3ds/viewport.h lib3ds/vector.h lib3ds/types.h lib3ds/tracks.h lib3ds/tcb.h lib3ds/shadow.h lib3ds/quat.h lib3ds/node.h lib3ds/mesh.h lib3ds/matrix.h lib3ds/material.h lib3ds/light.h lib3ds/io.h lib3ds/file.h lib3ds/ease.h lib3ds/chunktable.sed lib3ds/chunktable.h lib3ds/chunk.h lib3ds/camera.h lib3ds/background.h lib3ds/atmosphere.h cameracontrol.h collisionmanager.h .tmp/EntornQTGC21.0.0/ && $(COPY_FILE) --parents main.cpp uigc2.cpp Model.cpp GLWidget.cpp objectloader.cpp lib3ds/viewport.c lib3ds/vector.c lib3ds/tracks.c lib3ds/tcb.c lib3ds/shadow.c lib3ds/quat.c lib3ds/node.c lib3ds/mesh.c lib3ds/matrix.c lib3ds/material.c lib3ds/light.c lib3ds/io.c lib3ds/file.c lib3ds/ease.c lib3ds/chunk.c lib3ds/camera.c lib3ds/background.c lib3ds/atmosphere.c cameracontrol.cpp collisionmanager.cpp .tmp/EntornQTGC21.0.0/ && $(COPY_FILE) --parents uigc2.ui .tmp/EntornQTGC21.0.0/ && (cd `dirname .tmp/EntornQTGC21.0.0` && $(TAR) EntornQTGC21.0.0.tar EntornQTGC21.0.0 && $(COMPRESS) EntornQTGC21.0.0.tar) && $(MOVE) `dirname .tmp/EntornQTGC21.0.0`/EntornQTGC21.0.0.tar.gz . && $(DEL_FILE) -r .tmp/EntornQTGC21.0.0
